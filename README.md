...
|[Análise e validação de modelo de simulação numérica para previsão de ruído aerodinâmico utilizando OpenFOAM e Libacoustics](https://repositorio.ufsc.br/handle/123456789/228458?show=full): **MSc Thesis**|![acoustic field around tandem](https://github.com/unicfdlab/libAcoustics/blob/master/figures/Tandem-acoustic-field.png)|[Quadcopter drones swarm aeroacoustics](https://doi.org/10.1063/5.0052505): **Article**|![velocity field around a swarm of drones moving at 9 m/s in the flight direction](https://pubs.aip.org/view-large/figure/79647465/057112_1_f6.jpg)|[Computational aeroacoustics of quadcopter drones](https://doi.org/10.1016/j.apacoust.2022.108738): **Article**|![A DJI Mavic Air Drone (a) with four propellers (Quadrotor UAV). Computational CFD model showing the mesh of hexahedral cells (b). The propellers were replaced by virtual blades zones in the multiscale CFD domain.](https://ars.els-cdn.com/content/image/1-s2.0-S0003682X22001128-gr1.jpg)
