...
Foam::FWHSampledTriSurfaceMesh::sampleField
(
...
template<class Type>
Foam::tmp<Foam::Field<Type> >
Foam::FWHSampledTriSurfaceMesh::interpolateField
(
...
//Added from SampledSurface class
template<class Type>
bool Foam::FWHSampledTriSurfaceMesh::checkFieldSize(const Field<Type>& field) const
{
...
template<class Type>
Type Foam::FWHSampledTriSurfaceMesh::integrate(const Field<Type>& field) const
{
...
template<class Type>
Type Foam::FWHSampledTriSurfaceMesh::integrate(const tmp<Field<Type> >& field) const
{
